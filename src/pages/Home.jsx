...
import { bag_brickred, bag_brown, bag_cream, bag_girlie, bag_mainbg, bag_paperbag, bag_white, bg_ladyakimbo } from '../assets/images'
  ...
  return (
    <main>
        ...
        <div className="container mx-auto">
          <div className="grid  lg:grid-cols-2 grid-cols-1 grid-rows-1 gap-4 justify-center ">
            <div className="relative h-46 lg:h-80 ">
              ...
              <div className="absolute flex gap-8 bottom-3 left-3 text-white">
                <h4 className="text-2xl lg:text-5xl text-light lg:max-w-md relative pb-5 after:h-1 after:bg-primary after:bottom-0 after:left-0 after:absolute after:w-[30%] lg:after:w-[30%] font-semibold">Mule Sandal Series</h4>
            ...
            <div className="relative h-46 lg:h-80 ">
              ...
              <div className="absolute inset-0 bg-black opacity-50"></div>
              <div className="absolute  flex gap-8 bottom-3 left-3 text-white">
                <h4 className="text-2xl lg:text-5xl text-light lg:max-w-md relative pb-5 after:h-1 after:bg-primary after:bottom-0 after:left-0 after:absolute after:w-[30%] lg:after:w-[30%] font-semibold">Angel Sunglasses Series </h4>
                <button className="cursor-pointer h-12 w-12 rounded-full bg-primary text-white grid place-items-center text-base lg:text-lg font-bold "><FaArrowRight className="-rotate-45 group-hover:rotate-0" /></button>
              </div>
            </div>
            <div className="relative lg:col-span-2">
              ...
              <div className="absolute gap-8 inset-0 bg-black opacity-50 w-full h-full" ></div>
              <div className="absolute flex  top-3 right-3 text-white">
                <h4 className="text-2xl lg:text-5xl text-light lg:max-w-md relative pb-5 after:h-1 after:bg-primary after:bottom-0 after:left-0 after:absolute after:w-[30%] lg:after:w-[30%] font-semibold">Bottega Venete Women Exclusive Series </h4>
                <button className="cursor-pointer h-12 w-12 rounded-full bg-primary text-white grid place-items-center text-base lg:text-lg font-bold "><FaArrowRight className="-rotate-45 group-hover:rotate-0" /></button>
              </div>
              {/* </div> */}
            </div>
      ...
      <section className="relative py-10 px-4">
        <div className="container mx-auto flex flex-col gap-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <h4 className="text-3xl lg:text-5xl text-secondary lg:max-w-md relative pb-10 after:h-1 after:bg-primary after:bottom-0 after:left-0 after:absolute after:w-[58%] font-semibold">Our <span className="text-primary">Customers</span> Reviews</h4>
            <p className='text-justify text-sm lg:text-base lg:max-w-md'>The article element represents a complete, or self-contained, composition in a document, page, application, or site and that is, in principle, independently a magazine or newspaper article, a blog entry, a user-submitted comment, an interactive widget or gadget.</p>
          </div>
